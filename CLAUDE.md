...
## Правило: после каждого коммита

После каждого `git commit` проверить: нужно ли обновить этот файл CLAUDE.md?
Обновлять если:
- изменилась архитектура или ключевое решение
- появилась новая зависимость или файл
- изменился статус "Текущее состояние"
- добавлен новый проект или агент

Если обновил — включить изменения CLAUDE.md в тот же коммит (или сразу следующий).
