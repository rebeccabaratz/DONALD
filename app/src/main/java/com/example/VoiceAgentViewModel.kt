...
class VoiceAgentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun buildSystemPrompt(): String {
        ...
        - repeat_phrase() — пользователь ошибся. Скажи коротко что именно неверно и как правильно — например "не 'went', а 'said'" — затем вызови repeat_phrase(). После вызова произнеси ТОЛЬКО фразу которую вернёт система.
