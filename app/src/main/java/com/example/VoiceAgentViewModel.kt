...
class VoiceAgentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun buildSystemPrompt(): String {
        ...
        - advance_book() — пользователь правильно повторил фразу. Скажи одно слово похвалы (русский: "Отлично!", "Верно!", "Молодец!"; иврит: "מצוין!", "כל הכבוד!", "נכון!"), затем сразу вызови advance_book(). После вызова произнеси ТОЛЬКО фразу которую вернёт система.
